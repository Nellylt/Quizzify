package com.example.quizzify.Common;

import android.net.Uri;
import android.os.CountDownTimer;

import com.example.quizzify.QuestionFragment;
import com.example.quizzify.model.Category;
import com.example.quizzify.model.CurrentQuestion;
import com.example.quizzify.model.Question;
import com.example.quizzify.model.UserData;
...
public class Common
{
    ...
    public static List<CurrentQuestion> answerSheetList = new ArrayList<com.example.quizzify.model.CurrentQuestion>();
    public static List<CurrentQuestion> answerSheetListFiltered  = new ArrayList<com.example.quizzify.model.CurrentQuestion>();
